...
{?>
	<p>You are not logged in. While you can take the personality test, your result will not be stored.</p>
	<? }
...
echo $qname;
echo '<br/>';
echo form_radio($qstring, '1', set_radio($qstring, '1')) . $answers[2 * ($i - 1)];
echo '<br/>';
echo form_radio($qstring, '-1', set_radio($qstring, '-1')) . $answers[2 * ($i - 1) + 1];
echo '<br/>';
echo form_radio($qstring, '0', set_radio($qstring, '0')) . 'I am really in between';
echo '<br/>';
}
